FactoryGirl.define do
  factory :email, class: OpenStruct do
    ...
    trait :fresh_direct_receipt_one do
      ...
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/fresh_direct/receipt_one.eml')
      raw_text File.read('/Users/woodchip/pushcart_sample_emails/fresh_direct/receipt_one.eml')
    end

    trait :fresh_direct_receipt_two do
      from 'receipt@freshdirect.com'
      subject 'Your order for Sunday, Jan 26 2014'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/fresh_direct/receipt_two.eml')
      raw_text File.read('/Users/woodchip/pushcart_sample_emails/fresh_direct/receipt_two.eml')
    end

    trait :fresh_direct_receipt_three do
      from 'receipt@freshdirect.com'
      subject 'Your order for Sunday, Aug 3 2014'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/fresh_direct/receipt_three.eml')
      raw_text File.read('/Users/woodchip/pushcart_sample_emails/fresh_direct/receipt_three.eml')
    end
    ...
    trait :fresh_direct_auto_forward_receipt_one do
      ...
      raw_text File.read('/Users/woodchip/pushcart_sample_emails/fresh_direct/gmail_autoforward_receipt.eml')
    end
    ...
    trait :fresh_direct_gmail_api_receipt_one do
      ...
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/fresh_direct/gmail_api_receipt.eml')
    end

    trait :instacart_receipt do
      from 'orders@instacart.com'
      subject 'Fwd: Your Order with Instacart'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/instacart/instacart_receipt.eml')
    end

    trait :peapod_receipt_one do
      from 'yourfriends@peapod.com'
      subject 'Peapod by Stop & Shop Order Confirmation j50570360'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/peapod/receipt_one.eml')
    end

    trait :peapod_receipt_two do
      from 'yourfriends@peapod.com'
      subject 'Fwd: Peapod by Stop & Shop Order Confirmation j49123888'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/peapod/receipt_two.eml')
    end

    trait :peapod_receipt_three do
      from 'yourfriends@peapod.com'
      subject 'Fwd: Peapod by Stop & Shop Order Confirmation j48340159'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/peapod/receipt_three.eml')
    end
    ...
    trait :seamless_receipt_one do
      ...
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/seamless/receipt_one.eml')
    end

    trait :seamless_receipt_two do
      from 'confirmation@seamless.com'
      subject 'Confirmed! Chaska Fine Indian Cuisine received your order.'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/seamless/receipt_two.eml')
    end

    trait :seamless_receipt_three do
      from 'confirmation@seamless.com'
      subject 'Confirmed! Shinju III received your order. Estimated Delivery: 30 - 45 minutes'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/seamless/receipt_three.eml')
    end
    ...
    trait :seamless_gmail_api_receipt_one do
      ...
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/seamless/gmail_api_receipt.html')
    end

    trait :grubhub_receipt_one do
      from 'order@grubhub.com'
      subject 'Your Order from Jellyfish is in the Works'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/grubhub/receipt_one.eml')
    end

    trait :grubhub_receipt_two do
      from 'order@grubhub.com'
      subject 'Your Order from Kodama Sushi is in the Works'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/grubhub/receipt_two.eml')
    end

    trait :grubhub_receipt_three do
      from 'order@grubhub.com'
      subject 'Your Order from Taste of Thai Express is in the Works'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/grubhub/receipt_three_html.html')
    end

    trait :grubhub_receipt_four do
      from 'orders@grubhub.com'
      subject 'Your Order from Tiengarden Vegan Kitchen is in the Works'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/grubhub/receipt_four_html.html')
    end

    trait :grubhub_gmail_api_receipt_one do
      from 'GrubHub <order@grubhub.com>'
      subject 'Your Order from Jellyfish is in the Works'
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/grubhub/gmail_api_receipt.html')
    end
    ...
    trait :caviar_receipt_one do
      ...
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/caviar/receipt_one.eml')
    end

    trait :caviar_receipt_two do
      from 'nycsupport@trycaviar.com'
      subject "Your Caviar Order from Otto's Tacos for delivery on February 4th"
      raw_html File.read('/Users/woodchip/pushcart_sample_emails/caviar/receipt_two.eml')
    end
    ...
    trait :gmail_autoforwarder_one do
      ...
      raw_text File.read('/Users/woodchip/pushcart_sample_emails/gmailers/autoforwarder_one.eml')
    end

    trait :gmail_autoforwarder_two do
      from 'forwarding-noreply@google.com'
      subject '(#867308695) Gmail Forwarding Confirmation - Receive Mail from lopez.juanr@gmail.com'
      raw_text File.read('/Users/woodchip/pushcart_sample_emails/gmailers/autoforwarder_two.eml')
    end

FactoryGirl.define do
  factory :email, class: OpenStruct do
    ...
    trait :fresh_direct_receipt_three do
      ...
      raw_html File.read('./pushcart_sample_emails/fresh_direct/receipt_three.eml')
      raw_text File.read('./pushcart_sample_emails/fresh_direct/receipt_three.eml')
    end

    trait :fresh_direct_receipt_four do
      from 'receipt@freshdirect.com'
      subject 'Fwd: Your order for Tuesday, Aug 5 2014'
      raw_html File.read('./pushcart_sample_emails/fresh_direct/receipt_four.eml')
      raw_text File.read('./pushcart_sample_emails/fresh_direct/receipt_four.eml')
    end

    trait :fresh_direct_receipt_five do
      from 'receipt@freshdirect.com'
      subject 'Fwd: Your order for Sunday, Jan 26 2014'
      raw_html File.read('./pushcart_sample_emails/fresh_direct/receipt_five.eml')
      raw_text File.read('./pushcart_sample_emails/fresh_direct/receipt_five.eml')
    end

    trait :fresh_direct_auto_forward_receipt_one do
      from 'receipt@freshdirect.com'
      subject 'Fwd: Your order for Sunday, Aug 17 2014'
      raw_text File.read('./pushcart_sample_emails/fresh_direct/gmail_autoforward_receipt.eml')
    end
    ...
    trait :fresh_direct_gmail_api_receipt_one do
      ...
      raw_html File.read('./pushcart_sample_emails/fresh_direct/gmail_api_receipt.eml')
    end
    ...
    trait :caviar_receipt_one do
      ...
      raw_html File.read('./pushcart_sample_emails/caviar/receipt_one.eml')
    end

    trait :caviar_receipt_two do
      from 'nycsupport@trycaviar.com'
      subject "Your Caviar Order from Otto's Tacos for delivery on February 4th"
      raw_html File.read('./pushcart_sample_emails/caviar/receipt_two.eml')
    end
    ...
    trait :gmail_autoforwarder_one do
      ...
      raw_text File.read('./pushcart_sample_emails/gmailers/autoforwarder_one.eml')
    end

    trait :gmail_autoforwarder_two do
      from 'forwarding-noreply@google.com'
      subject '(#867308695) Gmail Forwarding Confirmation - Receive Mail from lopez.juanr@gmail.com'
      raw_text File.read('./pushcart_sample_emails/gmailers/autoforwarder_two.eml')
    end
